...
void Omni4WD::rectangle(unsigned int speedMMPS,unsigned int duration,
		unsigned int uptime,bool debug) {
		int (Omni4WD::*carAction[])(int speedMMPS)={
		&Omni4WD::setCarAdvance,
		&Omni4WD::setCarRight,
		...
		delayMS(duration*2,debug);
		setCarSlow2Stop(uptime);
		(this->*carAction[3])(0); // default parameters not available in function pointer
		setCarSpeedMMPS(speedMMPS,uptime);
		delayMS(duration,debug);
		setCarSlow2Stop(uptime);
	setCarStop();
...
void Omni4WD::cercle(unsigned int speedMMPS,unsigned int duration,
		unsigned int uptime,bool debug) {
		int (Omni4WD::*carAction[])(int speedMMPS)={
		&Omni4WD::setCarAdvance,
		&Omni4WD::setCarRotateRight,
	...
	(this->*carAction[0])(0); // default parameters not available in function pointer
		setCarSpeedMMPS(speedMMPS,uptime);
		delayMS(duration*3,debug);
		setCarSlow2Stop(uptime*3);
		(this->*carAction[1])(0); // default parameters not available in function pointer
		setCarSpeedMMPS(speedMMPS,uptime);
		delayMS(duration,debug);
		setCarSlow2Stop(uptime);
